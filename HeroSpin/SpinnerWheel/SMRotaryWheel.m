...
- (void) drawWheel {
    ...
    NSArray *characterArray = [dictionary objectForKey:@"Marvel"];
...
//        }
        ...
        labelName.text = characterArray[i];
    ...
    /*
    UIImageView *mask = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 108, 108)];
